  ...
  return (
    <div className="flex min-h-[80vh] items-center justify-center px-4 py-16">
      <div className="w-full max-w-sm text-center">
        ...
        <h1 className="mt-6 font-serif text-2xl text-text-heading">Thank you for your purchase!</h1>
        <p className="mt-2 text-sm text-text-muted">
          Your payment was successful and {credits} credits have been added to your account.
        </p>
