      ...
      <div className="w-full max-w-sm">
        ...
        <div className="mt-8 space-y-3">
          {process.env.NEXT_PUBLIC_AUTH0_ENABLED === "true" && (
            <SocialButton onClick={() => signIn("auth0", { callbackUrl: "/" })} label="Continue with Auth0">
          ...
          <SocialButton onClick={() => signIn("github", { callbackUrl: "/" })} label="Continue with GitHub">
          ...
          {process.env.NEXT_PUBLIC_GOOGLE_ENABLED === "true" && (
            <SocialButton onClick={() => signIn("google", { callbackUrl: "/" })} label="Continue with Google">
              <svg className="h-4 w-4" viewBox="0 0 24 24" fill="currentColor">
